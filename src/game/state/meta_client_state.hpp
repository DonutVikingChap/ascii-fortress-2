#ifndef AF2_STATE_META_CLIENT_STATE_HPP
#define AF2_STATE_META_CLIENT_STATE_HPP

#include "game_state.hpp"

class Game;

class MetaClientState final : public GameState {
public:
	explicit MetaClientState(Game& game);
